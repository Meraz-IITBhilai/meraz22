...
<div class="bodyy">
    ...
    <div class="main-container">
        <div class="poster-container">
            <img class="poster1" src="/assets/poster/Surreal.jpg" alt="overflow" border="0">
        </div>
        <div class="text-container">
            ...
            <div class="description">
                <div class="description-container">
                    <p>
                        Have a voice which can mesmerize people and get them immersed in your singing? <br>Here is the platform to showcase your vocal talent and win the hearts of the audience <br> with your melody and rhythm. Unleash the singer within you with सुर-REAL(Surreal) - The solo song competition.</p>
                </div>
