...
<div class="bodyy">
    ...
    <div class="main-container">
        <div class="poster-container">
            <img alt="not found" class="poster1" src="/assets/poster/Phantom.png"  border="0">
        </div>
        <div class="text-container">
            ...
            <div class="top-text">
		     ...
		     <Register link="https://forms.gle/zwLU56ZLe3Rei8T68"/>
                <h2 class="club-name">
                    DESIGNX
                </h2>
            </div>
            ...
            <div class="description">
                <div class="description-container">
                    <p>
                        UI design is all about creating intuitive, aesthetically-pleasing, interactive interfaces. <br> All the participants should make a “Futuristic redesign of Stock Android”. <br> This competition is to encourage participants to think out of the box and to explore their creativity. All the entries will be posted on the Instagram handle of DesignX (designx_iitbhilai).</p>
                </div>
                ...
                <div class="sub-container">
                    ...
                    <div class="button-container">
                        <a href="https://docs.google.com/document/d/1J9ENjwEZRngagICiPDa-Iilj8sPglCdJ5jK7hvvvVHM/edit">
