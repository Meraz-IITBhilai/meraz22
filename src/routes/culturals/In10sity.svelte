...
<div class="bodyy">
    ...
    <div class="main-container">
        <div class="poster-container">
            <img alt="not found" class="poster1" src="/assets/poster/in10sity.png" alt="overflow" border="0">
        </div>
